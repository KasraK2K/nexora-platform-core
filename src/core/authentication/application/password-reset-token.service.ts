...
/** Raw password-reset secret and the hash persisted by the server. */
export type PasswordResetToken = { raw: string; hash: string };

const TOKEN_PATTERN = /^[A-Za-z0-9_-]{43}$/;

/** Creates and validates single-use password-reset secrets. */
@Injectable()
