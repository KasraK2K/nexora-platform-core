...
import type { MembershipOwnershipTransferRateLimitDecision } from './membership-ownership-transfer-rate-limiter';
...
@Injectable()
export class MembershipOwnershipTransferRateLimiter {
  constructor(
